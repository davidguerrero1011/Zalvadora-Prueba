<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="fas fa-user-plus"></i>Crear Producto</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="sku" name="sku" value="<?= set_value('sku') ?>" required>
                </div>
            </div>
        </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="category_id" id="category_id" class="form-select" required>
                        ...
                        <?php foreach ($categories as $category): ?>
                            <option value="<?= $category->id ?>" <?= set_select('category_id', $category->id); ?>> <?= htmlspecialchars($category->name); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
